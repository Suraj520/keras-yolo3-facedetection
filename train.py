...
def _main():
    train_annotation_path = './annotations/wider_train_annotation.txt'
    val_annotation_path = './annotations/wider_val_annotation.txt'
    log_dir = './logs/000/'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='./model_data/wider_face_yolo.h5') # make sure you know what you freeze
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
            weights_path='model_data/wider_face_yolo.h5'):
